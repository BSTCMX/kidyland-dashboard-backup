<script lang="ts">
   ...
   * 
   * Display-only dashboard for monitor role (read-only version of recepcion dashboard).
   */
  import { onMount, onDestroy } from "svelte";
  import { goto } from "$app/navigation";
  import { page } from "$app/stores";
  import { user, hasAccessSecure, hasRole } from "$lib/stores/auth";
  ...
  $: recepcionPerms = $user ? getModulePermissions($user.role, "recepcion") : null;
  $: readonly = !recepcionPerms?.canEdit;
  ...
  onMount(() => {
    ...
    // This prevents race conditions where fetchRecepcionStats() executes with stale token
    ...
    <div class="dashboard-header">
      <div>
        ...
        <p class="page-description">
          Estadísticas de recepción (solo lectura).
        </p>
      </div>
      ...
      {#if sales}
        <div class="stats-grid">
          ...
          <div class="stat-card">
            ...
            <div class="stat-details">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value">{sales.service_count || 0}</span>
              </div>
              <div class="detail-item">
          ...
          <div class="stat-card">
            ...
            <div class="stat-value">{stats.active_timers || 0}</div>
          ...
          <div class="stat-card">
            ...
            <div class="stat-value">{stats.tickets?.generated_today || 0}</div>
