<script lang="ts">
  /**
   * Reports page - Advanced analytics and reporting dashboard (Read-only).
   * 
   * Features:
   * - Modular tabs for different report sections
   * - Global filters (date, sucursal, module)
   * - Interactive visualizations
   * - Export capabilities (read-only access)
   */
                ...
                <div class="kpis-grid">
                  ...
                  {:else if $reportsStore.sales}
                    <div class="metric-card">
                      ...
                      <div class="metric-value">{formatPrice($reportsStore.sales.total_revenue_cents || 0)}</div>
                    </div>
                  {/if}
                  
                  {#if $reportsStore.sales}
                    <div class="metric-card">
                      <h4 class="metric-title">Total Ventas</h4>
                      <div class="metric-value">{$reportsStore.sales.sales_count || 0}</div>
                    </div>
                    
                    <div class="metric-card">
                      <h4 class="metric-title">Ticket Promedio (ATV)</h4>
                      <div class="metric-value">{formatPrice($reportsStore.sales.average_transaction_value_cents || 0)}</div>
                    </div>
                  {/if}
                </div>
              </div>
              ...
              <div class="advanced-metrics-section">
                {#if $reportsStore.sales}
                  <SalesAdvancedMetrics
                    salesCount={$reportsStore.sales.sales_count || 0}
                    totalRevenueCents={$reportsStore.sales.total_revenue_cents || 0}
                    averageTransactionValueCents={$reportsStore.sales.average_transaction_value_cents || 0}
                  ...
                  <div class="module-comparison-grid">
                    <div class="module-card recepcion">
                      ...
                      <div class="module-metrics">
                        <div class="module-metric">
                          <span class="metric-label">Revenue:</span>
                          <span class="metric-value">{formatPrice($reportsStore.moduleComparison?.recepcion?.revenue_cents || 0)}</span>
                        </div>
                        <div class="module-metric">
                          <span class="metric-label">Ventas:</span>
                    ...
                    <div class="module-card kidibar">
                      ...
                      <div class="module-metrics">
                        <div class="module-metric">
                          <span class="metric-label">Revenue:</span>
                          <span class="metric-value">{formatPrice($reportsStore.moduleComparison?.kidibar?.revenue_cents || 0)}</span>
                        </div>
                        <div class="module-metric">
                          <span class="metric-label">Ventas:</span>
